...
<td> <input type ="image" src="<c:url value='/images/yy.jpg'/>" ></td>
      </tr>
      <tr>
           <%/* 读取txt文件 */
	FileReader reader = new FileReader("D:/Users/acer/Workspaces/MyEclipse 10/Hospital/WebRoot/css/hospital.txt");
